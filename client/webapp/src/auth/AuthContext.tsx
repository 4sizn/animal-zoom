...
type AuthState = {
  ...
  forgotPassword: (dto: ForgotPasswordDto) => Promise<{ ok: boolean; error?: string }>;
  logout: () => void;
};
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const [socketStatus, setSocketStatus] = React.useState<AuthState["socketStatus"]>("disconnected");
  ...
  React.useEffect(() => {
    ...
    const socket = io(`${API_BASE_URL}/zoom`, {
