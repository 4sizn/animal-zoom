...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('currentParticipants', 'integer', (col) =>
      col.notNull().defaultTo(0),
    )
    .addColumn('maxParticipants', 'integer', (col) =>
      col.notNull().defaultTo(50),
    )
