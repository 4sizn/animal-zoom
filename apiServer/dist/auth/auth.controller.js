...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create guest user token' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Guest token created' }),
    __param(0, (0, common_1.Body)(common_1.ValidationPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateGuestDto]),
    __metadata("design:returntype", Promise)
