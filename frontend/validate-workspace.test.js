...
test('tsconfig.base.json has valid configuration', () => {
  ...
  assert(tsconfig.compilerOptions, 'tsconfig.base.json must have compilerOptions');
  assert(tsconfig.compilerOptions.strict, 'TypeScript strict mode must be enabled');
  assert(
